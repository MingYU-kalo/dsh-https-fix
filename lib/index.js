...
export function apply(ctx, config) {
  ...
  async function rpcResponse(endpoint, request) {
    ...
    try {
      ...
      return rpcEnvelope("invalid", { ok: false, error: { code: "bad-request", message: "body is not JSON", details: {} } })
    }
    const rpcId = body && typeof body.rpcId === "string" ? body.rpcId : "invalid"
