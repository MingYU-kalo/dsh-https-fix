...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const cssText = [
      ...
      ".hf_grid{display:flex;gap:16px;flex-wrap:wrap}",
      ".hf_grid>.hf_field{flex:1 1 200px;min-width:180px}",
    ...
    const css = {
      ...
      input: "hf_input", inputMono: "hf_inputMono", check: "hf_check", row: "hf_row", grid: "hf_grid",
      ...
      return jsxs("li", { className: cx(css.card, open && css.cardOpen), children: [
        ...
        open ? jsxs("div", { className: css.body, children: [
          ...
          jsxs(Section, { first: true, title: "HTTPS 服务", hint: "插件按下面的地址与端口启动内置 HTTPS 反代,转发到 dsh 本机 http 端口", children: [
            ...
            jsxs("div", { className: css.grid, children: [
          ...
          jsxs(Section, { title: "TLS 证书", hint: "没有域名时用自动自签;也可以填自有证书路径", children: [
            ...
            mode === "paths" ? jsxs("div", { className: css.grid, children: [
              jsxs(Field, {
