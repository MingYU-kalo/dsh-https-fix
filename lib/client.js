...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** sha256("admin"):与 host 侧 auth.js 的默认值一致,用于「重置为默认密码」与状态判断。 */
    ...
    function HttpsFixCard(props) {
      ...
      function resetPasswordToDefault() {
        setPwInput("");
        setPwError("");
        set("loginPasswordHash", DEFAULT_PW_HASH);
      }
            ...
            jsxs(Field, {
              ...
              children: jsxs(React.Fragment, { children: [
                jsxs("div", { className: css.row, children: [
                  ...
                  jsx("button", { type: "button", className: css.inlineBtn, disabled: !writable, onClick: resetPasswordToDefault, children: "重置为默认密码" }),
