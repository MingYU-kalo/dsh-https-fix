    ...
    function HttpsFixCard(props) {
      ...
      return jsxs("li", { className: cx(css.card, open && css.cardOpen), children: [
        ...
        open ? jsxs("div", { className: css.body, children: [
          ...
          jsx(Field, { label: "https 端口", children: [
            jsx(BoolField, { label: "使用 http 端口", value: cur("httpsSamePort"), disabled: !writable, onChange: (v) => set("httpsSamePort", v) }),
            jsx(NumberField, { value: cur("httpsPort"), placeholder: "3081", disabled: !writable || cur("httpsSamePort") === true, onChange: (v) => set("httpsPort", v) })
          ] }),
